...
public class HnStopLiveModel extends BaseResponseModel {
    ...
    public static class DBean {
         ...
         * anchor_live_like_total : 0
         * anchor_live_onlines : 0
         * anchor_ranking : 0
         * is_create_record : Y
         * live_time : 0
         * store : {"live_goods_sales":"0"}
         * user_avatar :
         * user_dot : 0
         * user_id : 8
         * user_nickname : 2
        ...
        public static class StoreEntity {
            ...
            public void setLive_goods_sales(String live_goods_sales) {
                this.live_goods_sales = live_goods_sales;
            }

            public String getLive_goods_sales() {
                return live_goods_sales;
            }
        }
    }
}
