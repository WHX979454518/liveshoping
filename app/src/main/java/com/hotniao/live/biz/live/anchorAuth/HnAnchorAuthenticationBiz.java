package com.hotniao.live.biz.live.anchorAuth;
...
public class HnAnchorAuthenticationBiz {
     ...
     */
    public void requestToCommitAnchorApply(String userName, String phone, String userIdCard, String onePath, String twoPath, String threePath, boolean isCheck,String code) {
        if (!HnRegexUtils.isIDCard18(userIdCard)) {
        ...
        param.put("front_img", onePath);
        param.put("back_img", twoPath);
        param.put("user_img", threePath);
//        if (isCheck) {
