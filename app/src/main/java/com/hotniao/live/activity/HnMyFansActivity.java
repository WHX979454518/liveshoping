            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, final int position) {
                ...
                if (view.getId() == R.id.mTvFocus) {
                    if ("Y".equals(item.getIs_follow())) {
                        CommDialog.newInstance(HnMyFansActivity.this).setClickListen(new CommDialog.TwoSelDialog() {
                            @Override
                        ...
                        }).setTitle(getString(R.string.cancle_focus)).setContent(getString(R.string.cancle_focus_cannot_receive_live_msg)).show();
