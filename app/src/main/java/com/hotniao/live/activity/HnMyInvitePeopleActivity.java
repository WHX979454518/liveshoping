        ...
        return new HnResponseHandler<HnInvitePeopleModel>(HnInvitePeopleModel.class) {
            ...
            public void hnSuccess(String response) {
                ...
                if (model.getD().getInvite_user() == null) {
                    setEmpty(getString(R.string.go_to_invite_friends), R.drawable.empty_com);
                    return;
                }
                ...
                mTvHead.setText(getString(R.string.all_have)+mData.size()+getString(R.string.num_xiaji_daili));
                setEmpty(getString(R.string.go_to_invite_friends), R.drawable.empty_com);
            }
