...
public class HnInviteFriendActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.mLlCoin:
                startActivity(new Intent(HnInviteFriendActivity.this,HnUserBillEarningActivity.class).putExtra(HnConstants.Intent.DATA,2));
                break;
            case R.id.mLlPeople:
            ...
            case R.id.mTvInvite:
                ...
                HnShareDialog.newInstance(mShareAPI, mShareAction,mShare.getContent(),mShare.getLogo(),mShare.getUrl()).setItemShareListener(new HnShareDialog.onShareDialogListener() {
                    @Override
