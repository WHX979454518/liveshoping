...
public class HnWithDrawDetailActivity extends BaseActivity {
    ...
    private void withDrow(String id) {
        ...
        HnHttpUtils.postRequest(HnUrl.USER_WITHDRAW_DETAIL, mParam, HnUrl.USER_WITHDRAW_DETAIL, new HnResponseHandler<HnWithDrawDetailModel>(HnWithDrawDetailModel.class) {
            @Override
            public void hnSuccess(String response) {
                ...
                if (model.getC() == 0) {
                    ...
                    mAdapter.setSuccessState(model.getD().getStatus());
                    if (mAdapter != null) {
