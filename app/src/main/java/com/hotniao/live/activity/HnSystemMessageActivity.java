...
import com.hotniao.live.biz.msg.HnSystemMsgBiz;
...
public class HnSystemMessageActivity extends BaseActivity implements BaseRequestStateListener, HnLoadingLayout.OnReloadListener {
    ...
    public void requestSuccess(String type, String response, Object obj) {
        ...
        if ("System_Msg_Detail_List".equals(type)) {//系统消息详情
            ...
            if (model != null && model.getD() != null && model.getD().getSystem_dialog() != null) {
                List<GetSystemMsg.SystemDialogEntity> items = model.getD().getSystem_dialog();
                if (items.size() > 0)
    ...
    protected void setEmpty() {
        ...
        if (list.size() < 1) {
            ...
            mHnLoadingLayout.setEmptyText("暂时还没有消息哦").setEmptyImage(com.live.shoplib.R.drawable.empty_com);
        } else {
