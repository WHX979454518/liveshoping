...
//    private HnButtonTextWatcher mWatcher;
    ...
    public void onCreateNew(Bundle savedInstanceState) {
        ...
        mSubtitle.setTextColor(getResources().getColor(R.color.comm_text_color_main));
        mSubtitle.setText(R.string.commit);
...
//        etData.addTextChangedListener(mWatcher);
    ...
    private void updatePicData(String key) {
        switch (currentUploadPicPos) {
            case 0:
                picPath1 = key;
                ivPic1.setImageURI(HnUrl.setImageUri(key));
                ivPic1.setVisibility(View.VISIBLE);
                break;
            case 1:
                picPath2 = key;
                ivPic2.setImageURI(HnUrl.setImageUri(key));
                ivPic2.setVisibility(View.VISIBLE);
                break;
            case 2:
                picPath3 = key;
                ivPic3.setImageURI(HnUrl.setImageUri(key));
