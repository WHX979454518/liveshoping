...
import static com.hotniao.live.R.id.view;
...
public class HnSystemMsgAdapter extends BaseAdapter {
    ...
    public HnSystemMsgAdapter(Context context, List<GetSystemMsg.SystemDialogEntity> msgItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final GetSystemMsg.SystemDialogEntity bean = items.get(position);
        if (convertView == null) {
        ...
        holder.mUserHeader.setImageURI(Uri.parse("res:///" + R.drawable.system_image));
