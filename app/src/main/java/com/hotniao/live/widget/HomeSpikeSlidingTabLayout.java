 ...
 */
public class HomeSpikeSlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public HomeSpikeSlidingTabLayout(Context context) {
        this(context, null, 0);
    }

    public HomeSpikeSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HomeSpikeSlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
