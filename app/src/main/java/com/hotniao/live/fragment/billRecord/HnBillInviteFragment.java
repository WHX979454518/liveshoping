...
import com.hotniao.live.adapter.HnBillInViteEarningAdapter;
            ...
            public void hnSuccess(String response) {
                try {
                    ...
                    if (model.getC() == 0) {
                        ...
                        mTvTotal.setText( HnUtils.setTwoPoints(model.getD().getAmount_total())+ HnApplication.getmConfig().getCoin());
                        mHnLoadingLayout.setStatus(HnLoadingLayout.Success);
                        if (mPage == 1) {
                            mData.clear();
                        }
