...
public class HnPlatformListFragment extends CommListFragment implements BaseRequestStateListener {
    public static final String PlatfromList = "platfromListRank";//红鸟电商排行榜
        ...
        mAdapter = new CommRecyclerAdapter() {
            ...
            protected void onBindView(BaseViewHolder holder, final int position) {
                ...
                if (!TextUtils.isEmpty(mData.get(position).getLive_gift_coin())) {
                    ...
                    if( !PlatfromList.equals(getArguments().getString("type"))||mIsAnchor){
                        value=HnApplication.getmConfig().getDot();
        ...
        return new HnResponseHandler<HnFansContributeModel>(HnFansContributeModel.class) {
            ...
            public void hnSuccess(String response) {
                ...
                if (model.getD() == null || model.getD().getRank() == null || model.getD().getRank().getItems() == null) {
                    setEmpty(getString(R.string.now_no_ranking), R.drawable.no_ranking);
                    return;
                }
