...
public class HomeSortFrag extends BaseScollFragment {
    ...
    public static HomeSortFrag getInstance(String type,String name,boolean big){
        HomeSortFrag frag = new HomeSortFrag();
    ...
    protected CommRecyclerAdapter setAdapter() {
        ...
        return new CommRecyclerAdapter() {
            ...
            protected void onBindView(BaseViewHolder holder, final int position) {
                LiveItemProxy.setItemView_Live(holder, mData.get(position), "分类");
            }
