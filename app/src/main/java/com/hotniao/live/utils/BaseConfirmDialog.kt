...
import com.hotniao.live.utils.screenshoot.DiaLogBuilder
...
class BaseConfirmDialog {
    ...
    private var isShowtitle: Boolean = false//这个默认不显示title
    ...
    fun isShowtitle(isShowtitle: Boolean): BaseConfirmDialog {
