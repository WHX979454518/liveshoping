...
import com.hotniao.livelibrary.ui.beauty.view.RoundProgressBar;
...
public class MaterialAdapter extends RecyclerView.Adapter<MaterialAdapter.VideoViewHolder>{
    ...
    public VideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new VideoViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.live_camera_grid_item_video, parent, false));
    }
