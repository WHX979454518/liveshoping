...
public class HnAnchorViewBiz extends HnLiveBaseViewBiz {
     ...
     * @param tvHighLevel
     */
//    public void liveEffect(final Context context, String isLvEffect, String isVip, String nick,
//                           final LinearLayout llEnterRoom, TextView tvLevel, TextView tvHighLevel) {
//
//        try {
//            if (Integer.parseInt(isLvEffect) >=15) {
//
//                if (llEnterRoom.getVisibility() == View.INVISIBLE) {
//                    llEnterRoom.setVisibility(View.VISIBLE);
//                    tvLevel.setText(isLvEffect);
