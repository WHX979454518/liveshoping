...
public class HnPrivateChatListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final String content = dataList.get(position).getMsgContent();
...
//        String consume = dataList.get(position).giftConsume;
        ...
        switch (itemViewType) {
            ...
            case OWNER_TYPE:
                ...
                if (content.toLowerCase().startsWith(HnUpLoadPhotoControl.headUrl)) {
                    ownerHolder.mOnwerContent.setVisibility(View.GONE);
                    ownerHolder.mIvImgOwn.setVisibility(View.VISIBLE);
                    ownerHolder.mIvImgOwn.setImageURI(Uri.parse(HnUrl.setImageUrl(content)));
                    final OwnerHolder finalOwnerHolder = ownerHolder;
                    ownerHolder.mIvImgOwn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            launcher(finalOwnerHolder.mIvImgOwn, 0, content);
                        }
                    });
                } else {
                    ownerHolder.mOnwerContent.setVisibility(View.VISIBLE);
                    ownerHolder.mIvImgOwn.setVisibility(View.GONE);
                    try {
                ...
                //头像
                ownerHolder.mOwnerHeader.setImageURI(avatar);
                //头像点击I
            ...
            case USER_TYPE:
                if (content.toLowerCase().startsWith(HnUpLoadPhotoControl.headUrl)) {
                    userHolder.mUserContent.setVisibility(View.GONE);
                    userHolder.mIvImgUser.setVisibility(View.VISIBLE);
                    userHolder.mIvImgUser.setImageURI(Uri.parse(HnUrl.setImageUrl(content)));
                    final UserHolder finalUserHolder = userHolder;
                    userHolder.mIvImgUser.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            launcher(finalUserHolder.mIvImgUser, 0, content);
                        }
                    });
                } else {
                    userHolder.mUserContent.setVisibility(View.VISIBLE);
                    userHolder.mIvImgUser.setVisibility(View.GONE);
                    try {
                ...
                //头像
                userHolder.mUserHeader.setImageURI(Uri.parse(avatar));
                //头像点击I
...
//        DateUtils.setTimeShow(timeStr, textView,context);
    ...
    class OwnerHolder {
        ...
        public FrescoImageView mIvImgOwn;
        ...
        public OwnerHolder(View convertView) {
            ...
            mIvImgOwn = (FrescoImageView) convertView.findViewById(R.id.mIvImgOwn);
    ...
    class UserHolder {
        ...
        public FrescoImageView mIvImgUser;
        ...
        public UserHolder(View convertView) {
            ...
            mIvImgUser = (FrescoImageView) convertView.findViewById(R.id.mIvImgUser);
    ...
    private void launcher(View view, int position, String data) {
        Intent intent = new Intent(context, HnPhotoPagerActivity.class);
        Bundle args = new Bundle();
        args.putInt(HnPhotoPagerActivity.KEY_START_POS, Math.min(1, Math.max(0, position)));
        ...
        arrayList.add(data);
        args.putStringArrayList(HnPhotoPagerActivity.KEY_PHOTO_LIST, arrayList);
