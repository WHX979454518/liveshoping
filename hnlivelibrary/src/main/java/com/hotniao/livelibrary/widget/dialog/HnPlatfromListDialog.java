...
public class HnPlatfromListDialog extends DialogFragment {
        ...
        mAdapter = new CommRecyclerAdapter() {
            ...
            protected void onBindView(BaseViewHolder holder, int position) {
                ...
                if (position < 3) {
                    ...
                    ((FrescoImageView) holder.getView(R.id.mIvImg)).setImageURI(NetConstant.setImageUri(mData.get(position).getUser_avatar()));
                } else {
                    holder.getView(R.id.mTvFocus).setVisibility(View.GONE);
                    ...
                    ((FrescoImageView) holder.getView(R.id.mIvOther)).setImageURI(NetConstant.setImageUri(mData.get(position).getUser_avatar()));
                }
    ...
    private void setEmpty() {
        ...
        if (mData != null && mData.size() > 0) {
            ...
            mLoadingLayout.setEmptyText(getString(R.string.live_now_no_rank));
    ...
    private void setMessage() {
        ...
        if (mDbean != null) {
            ...
            if (TextUtils.isEmpty(mDbean.getAnchor().getAnchor_ranking())) {
                ...
                mIvAnchor.setImageURI(NetConstant.setImageUri(mDbean.getAnchor().getUser_avatar()));
