...
package com.hotniao.livelibrary.widget.periscope;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable gift_1 = getResources().getDrawable(R.drawable.gift_buy);
        Drawable gift_2 = getResources().getDrawable(R.drawable.gift_chop);
        Drawable gift_3 = getResources().getDrawable(R.drawable.gift_clothing);
        Drawable gift_4 = getResources().getDrawable(R.drawable.gift_hand);
        Drawable gift_5 = getResources().getDrawable(R.drawable.gift_heart);
        Drawable gift_6 = getResources().getDrawable(R.drawable.gift_give);
        ...
        dHeight = gift_1.getIntrinsicHeight();
        dWidth = gift_1.getIntrinsicWidth();
        ...
        // 初始化插补器
        interpolators = new Interpolator[6];
        interpolators[0] = line;
        interpolators[1] = acc;
        interpolators[2] = accdec;
        interpolators[3] = accdec;
        interpolators[4] = accdec;
        interpolators[5] = accdec;
