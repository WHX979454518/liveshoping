...
public class HnBannerLayout extends RelativeLayout {
    ...
    public static String NO_IMAGE = "no_content";
    ...
    private OnBannerSlidingItemClickListener onBannerslidingItemClickListener;
    ...
    public HnBannerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HnBannerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            throw new IllegalStateException("item count not equal zero");
    ...
    private ImageView getImageView(String url, final int position) {
        ...
        if (getContext() == null) return imageView;
        Glide.with(getContext()).load(url).placeholder(R.drawable.default_banner).error(R.drawable.default_banner).crossFade().into(imageView);
        return imageView;
    }
    ...
    /**
     * 通过反射拿到ViewPager的滑动器mScroller，改变ViewPager切换时间
     *
     * @param duration
     */
    ...
    public void setOnBannerSlidingItemClickListener(OnBannerSlidingItemClickListener onBannerslidingItemClickListener) {
        this.onBannerslidingItemClickListener = onBannerslidingItemClickListener;
    }
    ...
    public interface OnBannerSlidingItemClickListener {
        void onItemClick(int position);
    }
...
//                onBannerslidingItemClickListener.onItemClick(position);
