package com.live.shoplib.widget.scollorlayout;
...
public class ScrollableLayout extends LinearLayout {
    ...
    public ScrollableLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.ScrollableLayout);
        try {
            maxY = array.getDimensionPixelSize(R.styleable.ScrollableLayout_scrollable_maxScroll, 0);
        } finally {
            array.recycle();
        }
