...
public class HnUserControl {
    ...
    public static void cancelFollow(final String uid, final OnUserOperationListener listener) {
        ...
        HnHttpUtils.postRequest("/user/follow/delete", param, "取消关注", new HnResponseHandler<BaseResponseModel>(BaseResponseModel.class) {
            @Override
            public void hnSuccess(String response) {
                if (model.getC() == 0) {
                    if (listener != null) {
    ...
    public static void addFollow(final String uid, String mAnchorId, final OnUserOperationListener listener) {
        ...
        HnHttpUtils.postRequest("/user/follow/add", param, "添加关注", new HnResponseHandler<BaseResponseModel>(BaseResponseModel.class) {
            @Override
            public void hnSuccess(String response) {
                if (model.getC() == 0) {
                    if (listener != null) {
