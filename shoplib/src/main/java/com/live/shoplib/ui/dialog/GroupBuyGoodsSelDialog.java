...
public class GroupBuyGoodsSelDialog extends DialogFragment {

    private static GroupBuyGoodsSelDialog dialog;
    ...
    public static GroupBuyGoodsSelDialog newInstance(SpikeGoodsDetailsModel.DEntity bean, String go, GoodsSelDialog.OnSureClick listner) {
        dialog = new GroupBuyGoodsSelDialog(bean, go, listner);
        return dialog;
    }


    @SuppressLint("ValidFragment")
    public GroupBuyGoodsSelDialog(SpikeGoodsDetailsModel.DEntity bean, String go, GoodsSelDialog.OnSureClick listner) {
        this.bean = bean;
        this.go = go;
    ...
    private GoodsAttrBean getGoodsAttrBean() {
        ...
        goodsAttrBean.setNum_all(Integer.parseInt(bean.getGroup_goods().getSingle_limit()));
