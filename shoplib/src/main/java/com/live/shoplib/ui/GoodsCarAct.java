...
public class GoodsCarAct extends CommListActivity {
    ...
    private void initConfig() {
        mBoxAll = findViewById(R.id.mBoxAll);
        mTvAllMoney = findViewById(R.id.mTvAllMoney);
        mTvBug = findViewById(R.id.mTvBug);
            ...
            protected void onBindView(BaseViewHolder holder, final int position) {
                ...
                holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        CommDialog.newInstance(GoodsCarAct.this)
                                .setTitle("删除商品")
