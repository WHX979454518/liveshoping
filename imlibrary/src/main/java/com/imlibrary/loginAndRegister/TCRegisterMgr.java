...
public class TCRegisterMgr {
    ...
    public void init(Context context) {
        ...
        mTLSAccountHelper.setCountry(Integer.parseInt(TLSConfiguration.COUNTRY_CODE));
        mTLSAccountHelper.setTimeOut(TLSConfiguration.TIMEOUT);
        mTLSAccountHelper.setLocalId(TLSConfiguration.LANGUAGE_CODE);
