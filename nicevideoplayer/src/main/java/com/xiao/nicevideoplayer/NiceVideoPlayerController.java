...
public class NiceVideoPlayerController extends FrameLayout
    ...
    public interface LeftBackClickOnTinyWindow {
        void onClick();
    }

    private Context mContext;
    private LeftBackClickOnTinyWindow leftBackClickOnTinyWindow;
    ...
    private ImageView mShare,report;
    ...
    public NiceVideoPlayerController(String falg,Context context) {
        super(context);
        mContext = context;
        if(!falg.equals("")){
            biaoshi = falg;
    ...
    public void setLeftBackClickOnTinyWindow(LeftBackClickOnTinyWindow leftBackClickOnTinyWindow) {
        this.leftBackClickOnTinyWindow = leftBackClickOnTinyWindow;
    }
    ...
    public void onClick(View v) {
        if (v == mCenterStart) {
            ...
            if (mNiceVideoPlayer.isFullScreen()) {
                ...
                //当为小窗播放的时候，调用这个回调
                if (leftBackClickOnTinyWindow != null) {
                    leftBackClickOnTinyWindow.onClick();
                }
            }
            ...
            Toast.makeText(mContext, "举报", Toast.LENGTH_SHORT).show();
        }else if (v == this) {
